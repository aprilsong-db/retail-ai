    ...
    if "FROM sales" in sql:
        ...
        if "COUNT" in sql:
            ...
            return pd.DataFrame({
                ...
                'status': random.choices(['pending', 'processing', 'completed'], k=10),
        ...
        if "COUNT" in sql and "stock_level < reorder_point" in sql:
            ...
            return pd.DataFrame({
                ...
                'category': random.choices(['Electronics', 'Clothing', 'Food', 'Home'], k=10),
        ...
        if "COUNT" in sql:
            ...
            return pd.DataFrame({
                ...
                'start_time': ['9:00 AM', '10:00 AM', '11:00 AM', '2:00 PM', '3:00 PM'],
                'end_time': ['5:00 PM', '6:00 PM', '7:00 PM', '10:00 PM', '11:00 PM']
            })
