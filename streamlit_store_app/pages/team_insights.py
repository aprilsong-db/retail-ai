...
def show_performance_overview():
        ...
        performers = [
            {
                ...
                "achievements": ["Customer Service Excellence", "Sales Target Exceeded"]
            },
            {
                "name": "Mike Rodriguez",
                "role": "Store Associate", 
    ...
    with col2:
        ...
        attention_items = [
            {"employee": "James Park", "issue": "Late arrivals (3 times)", "severity": "medium"},
            {"employee": "Lisa Wong", "issue": "Low customer satisfaction", "severity": "high"},
            {"employee": "Tom Johnson", "issue": "Missed training session", "severity": "low"}
        ]
...
def show_scheduling_overview():
        ...
        for shift in shifts:
            ...
            for i, day in enumerate(days):
                with cols[i+1]:
                    ...
                    color = "#28a745" if count >= 5 else "#ffc107" if count >= 3 else "#dc3545"
                    st.markdown(f"<div style='text-align: center; color: {color}; font-weight: bold;'>{count}</div>", unsafe_allow_html=True)
    ...
    with col2:
        ...
        alerts = [
            {
                "type": "Understaffed",
                "details": "Wednesday 3-4 PM - Electronics",
                "severity": "high",
...
def show_team_analytics():
    ...
    with col2:
        ...
        for insight in insights:
            ...
            impact_color = {"positive": "#28a745", "negative": "#dc3545", "neutral": "#6c757d"}[insight["impact"]]
...
def show_feedback_management():
    ...
    with col1:
        ...
        for feedback in feedback_items:
            feedback_colors = {"Positive": "#28a745", "Suggestion": "#007bff", "Recognition": "#6f42c1", "Concern": "#dc3545"}
